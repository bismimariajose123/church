<%@ Page Title="" Language="C#" MasterPageFile="~/SuperAdminMaster.Master" AutoEventWireup="true" CodeBehind="Sup_Priest_NOT_Transfer.aspx.cs" Inherits="Diocese.Sup_Priest_NOT_Transfer" %>
                             ...
                             Search by Column <div style="width:20%">
                                 <table>
                                     <tr>
                                       ...
                                       <asp:ImageButton ID="Imgbtnsearch__not_transfer_or_equal_parish" runat="server" OnClick="Imgbtnsearch__not_transfer_or_equal_parish_Click" ImageUrl="~/images/search.png" Width="20px"/></th>
                                     </tr>
                                 </table>
