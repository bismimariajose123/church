                    ...
                    <asp:GridView runat="server" ID="GVSubAdminNotification" CellPadding="3" ForeColor="Black" GridLines="Vertical" BackColor="White" 
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="More Details" SortExpression="More Details">
                               <ItemTemplate>
                                  <asp:LinkButton ID="LinkBtnMoreDetails" runat="server" CommandArgument='<%#Eval("Memberid")%>' Text="View More Details" OnCommand="LinkBtnMoreDetails_Command" CommandName="Details"></asp:LinkButton>
                                   </ItemTemplate>
                                </asp:TemplateField>
                            ...
                            <asp:TemplateField HeaderText="Option" SortExpression="Option">
                               <ItemTemplate>
                                   <asp:Button ID="Downloadbtn" Text="Download"  runat="server" Visible="false" OnClick="Downloadbtn_Click" CommandName="Download" CommandArgument='<%#Eval("Memberid")%>'/>
                               </ItemTemplate>
                                </asp:TemplateField>
                           </Columns>
