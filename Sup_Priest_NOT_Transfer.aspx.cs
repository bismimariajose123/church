...
namespace Diocese
{
    public partial class Sup_Priest_NOT_Transfer : System.Web.UI.Page
    {
        ...
        {
            Session["Dt"] = objPriestDetails_BLL.GetPriest_NOT_Transfer_Details();
        ...
        protected void Imgbtnsearch__not_transfer_or_equal_parish_Click(object sender, ImageClickEventArgs e)
        {
            string searchstr = string.Empty;
            searchstr = TBsearch.Text;
            DataTable dt = new DataTable();
            dt = objPriestDetails_BLL.Get_Search_Priest_NOT_Transfer_Details(searchstr);
            if (dt.Rows.Count > 0)
            {
                GVPriestTable.DataSource = dt;
                GVPriestTable.DataBind();
            ...
            else
            {
                ...
                //Response.Redirect("Sup_Priest_NOT_Transfer.aspx");
