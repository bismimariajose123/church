...
<div class="w3layouts-main">
	<h2>CREATE FAMILY</h2>
		<div>
            ...
            <asp:TextBox ID="TBFamilyName" runat="server" CssClass="input" required=""></asp:TextBox>
			...
			<asp:TextBox ID="TBHeadName" runat="server" CssClass="input" required="" ></asp:TextBox>
           
              <label for="uname"><b>User Name</b></label>
			<asp:TextBox ID="TBUname" runat="server" CssClass="input" required=""></asp:TextBox>
            <label for="uname"><b>Password</b></label>
			<asp:TextBox ID="TBPass" runat="server" CssClass="input" TextMode="Password" required=""></asp:TextBox>
			
           <%-- input in loginform.css--%>
			    <label for="uname"><b>Ward Name </b></label>
            <asp:DropDownList ID="DDLWardName" runat="server" CssClass="input" AppendDataBoundItems="true" required="">
